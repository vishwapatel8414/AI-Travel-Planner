...
export default function Hotels({ sharedData, liveData, isLoading, onSearchSubmit }) {
  ...
  // 🎯 ૩ થી ૪ હોટેલ બતાવવા માટે AI લિસ્ટ અથવા ડિફોલ્ટ 3 શાનદાર હોટેલ
  const displayHotels = liveData?.hotels || [
    { hotel_name: `The Oberoi ${toCity}`, address: "Worli", rating: "5.0", price_per_night_in_inr: "25000" },
    { hotel_name: `Grand Hyatt ${toCity}`, address: "BKC Luxury Hub", rating: "4.8", price_per_night_in_inr: "14500" },
    { hotel_name: `Ginger Stay ${toCity}`, address: "Near Transit", rating: "4.2", price_per_night_in_inr: "3800" }
  ];

  return (
    <div className="space-y-6">
      {/* 🖼️ તારું ઓરિજિનલ બેનર */}
      ...
      {/* 🏨 તારું ઓરિજિનલ કાર્ડ લેઆઉટ (લૂપ સાથે) */}
          ...
          <div key={idx} className="bg-white rounded-2xl border border-slate-100 p-4 flex flex-col sm:flex-row gap-5">
            ...
            <div className="flex-1 flex flex-col justify-between">
              ...
              <div className="flex justify-between items-end border-t border-slate-50 pt-2 mt-2">
                <p className="text-base font-black text-slate-800"> can ₹{hotel.price_per_night_in_inr || hotel.price} <span className="text-[10px] text-slate-400 font-bold">/ night</span></p>
